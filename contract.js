...
// const publicKey = "GDGLROZUUV7HMEWRXGOAB2EN6Q2JXW6HMUKE7CKFOTDDSGBRTWABTKKL"
// const secretKey = "SC6KIQWR5W6MYQSTNFBPFSU4S5CHKM23AAOXDDXUEGNAYQAMBQL455L3"
// const sourceSecretKey = StellarSdk.Keypair.fromSecret(secretKey);;

// // const sourceKeypair = keypair
// const sourcePublicKey = publicKey
// // const account = server.loadAccount(sourcePublicKey);
// // console.log(account)
// // console.log(sourceSecretKey)
// // const dataName = 'exampleDataName';
// // const dataValue = 'exampleDataValue';
...
//       console.log('Manage Data operation succeeded:', transactionResult);
//     } catch (error) {
